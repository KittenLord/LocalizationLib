...
namespace LocalizationLib
{
    public static class Localization
    {
        ...
        public static string GetSafe(string path) => GetStringSafe(path);
        public static string GetSafe(string path, string localization) => GetStringSafe(path, localization);
        ...
        public static string GetStringSafe(string path) => PerformSingletonMethod(loc => loc.GetStringSafe(path));
        public static string GetStringSafe(string path, string localization) => PerformSingletonMethod(loc => loc.GetStringSafe(path, localization));
